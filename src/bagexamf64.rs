...
// This file holds a variety of test for the bagf64 structure
...
fn test1()
{
    ...
    assert_eq!( test_bag.size(), TEST_SIZE + 10 );
}
...
fn test4()
{
    ...
    assert_eq!( test_bag.size(), 15 );

    // Now testing capacity, should be 16.
    assert_eq!( test_bag.get_capacity(), 16 );
    ...
    assert_eq!( test_bag.size(), 14 );

    // Erasing one 10.
    assert!( test_bag.erase_one( &10.0 ) );
    assert_eq!( test_bag.size(), 13 );

    // Erasing the 1.
    assert_eq!( test_bag.erase( &1.0 ), 1 );
    assert_eq!( test_bag.size(), 12 );

    // Erasing the 15.
    assert_eq!( test_bag.erase( &15.0 ), 1 );
    assert_eq!( test_bag.size(), 11 );

    // Erasing the 5.
    assert_eq!( test_bag.erase( &5.0 ), 1 );
    assert_eq!( test_bag.size(), 10 );

    // Erasing the 11.
    assert_eq!( test_bag.erase( &11.0 ), 1 );
    assert_eq!( test_bag.size(), 9 );
    ...
    assert_eq!( test_bag.size(), 7 );

    // Erasing the 2.
    assert_eq!( test_bag.erase( &2.0 ), 1 );
    assert_eq!( test_bag.size(), 6 );
    ...
    assert_eq!( test_bag.get_capacity(), 1 );
